...
{
	$top_image = '<img src="'.core::config('website_url') . 'uploads/articles/topimages/'.$article['article_top_image_filename'].'" alt="[articleimage]"><br />';
	$top_image_nobbcode = '<img src="'.core::config('website_url') . 'uploads/articles/topimages/' . $article['article_top_image_filename'] . '" alt="[articleimage]">';
		...
		{
			$top_image = '<img src="' . core::config('website_url') . 'uploads/articles/tagline_images/thumbnails/' . $article['tagline_image'] . '" alt="[articleimage]"><br />
		...
		$templating->set('main_formaction', '<form id="form" method="post" action="'.core::config('website_url').'admin.php?module=articles&edit" enctype="multipart/form-data">');
		...
		foreach($article_images as $value)
		{
			...
			BBCode: <input type="text" class="form-control" value="[img]' . core::config('website_url') . 'uploads/articles/article_images/' . $value['filename'] . '[/img]" />
