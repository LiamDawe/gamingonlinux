...
if ($article_list)
{
	...
	foreach ($guest_subs as $email)
	{
		...
		<p>Here is your daily news digest from GamingOnLinux!</p>" . $email_article_list . '<p><em>Please be aware we generally post less on weekends as we take a little time off!</em></p><p>You can unsubscribe any time by just <a href="'.$unsub_link.'">clicking here</a>.';
