<?php
// steam game importer, Games only ordered by release date (for already released stuff)
...
$page = 1;
$url = "http://store.steampowered.com/search/?sort_by=Released_DESC&category1=998&os=linux&page=";
