...
$title = "A recap of the most popular Linux & SteamOS gaming articles for the last week, {$counter['counter']} posted in total";
...
$text .= "<br />All of this is possible thanks to <a href=\"http://patreon.com/liamdawe\">my Patreon campaign</a>, the awesome editors that work with me and our Supporters!<br />";
...
$db->sqlquery("INSERT INTO `articles` SET `author_id` = 1844, `date` = ?, `title` = ?, `slug` = ?, `tagline` = ?, `text` = ?, `show_in_menu` = 0, `tagline_image` = 'weeklyoverview.png'", array(core::$date, $title, $slug, $tagline, $text));
