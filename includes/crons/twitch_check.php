...
{
	$game = core::file_get_contents_curl("https://api.twitch.tv/helix/games?id=".$stream_details['data'][0]['game_id'], "GET", NULL, array("Client-ID: evrwv49gsfv75eb4t4ynt9yflga7eo"));
...
$fp = fopen(APP_ROOT . '/includes/crons/goltwitchcheck.json', 'w'); 
fwrite($fp, $to_file);
fclose($fp);
?>
