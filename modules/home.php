...
if (!isset($_GET['view']))
{
	...
	foreach ($articles_get as $article)
	{
		...
		if ($user->check_group(1,2) == true || $user->check_group(5))
		{
			...
			{
				$templating->set('editors_pick_link', " <a href=\"".url."index.php?module=home&amp;view=editors&amp;article_id={$article['article_id']}\"><span class=\"glyphicon glyphicon-heart-empty\"></span> <strong>Make Editors Pick</strong></a></p>");
			}
