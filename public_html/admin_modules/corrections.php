...
if(!defined('golapp')) 
{
	die('Direct access not permitted: correction reports');
}
...
if (isset($_POST['act']) && $_POST['act'] == 'delete')
{
	...
	if (isset($_GET['message']))
	{
		...
		$text = "Your correction report on [i][". $_POST['correction_title'] ."]({$core->config('website_url')}articles/{$_POST['article_id']})[/i] was: [quote]{$_POST['correction_text']}[/quote]{$text}";
